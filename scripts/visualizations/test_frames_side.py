...
Usage:
    python test_frames_side.py
    python test_frames_side.py --n 10 --conf 0.3
"""
...
from config import DATASET_DIR, MODEL_PATH, RESULTS_DIR , KPT_NAMES , ANNOTATED_VIDEOS , CONF_THRESHOLD , EXCLUDED_VIDEOS
...
def main():
    ...
    for video_id, frame_path in samples:
        ...
        combined = make_side_by_side(frame, pred, video_id, frame_path.name)

        out_path = out_video / f"{video_id}_{frame_path.stem}.jpg"
